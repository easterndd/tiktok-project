...
import { ArrowLeft, Bookmark, Check, ChevronRight, Clock3, FileText, Globe2, Play, Settings2, ShieldCheck, UserRound } from 'lucide-react';
...
export function ProfilePage() {
  ...
  return <section className={styles.page}>
    ...
    <section className={styles.profileHero}><div className={styles.avatar}><UserRound size={28} /></div><div><p className="eyebrow">{t(locale, 'welcome')}</p><h1>{profile.data?.displayName ?? t(locale, 'guest')}</h1></div></section>
