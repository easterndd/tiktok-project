...
BytePlus VOD setup, credentials, upload flow, and project-specific integration notes are documented in [`docs/byteplus-vod-project-manual.md`](docs/byteplus-vod-project-manual.md).
